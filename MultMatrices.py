...
if __name__ == '__main__':
    ...
    respuesta = input("\nFilas matriz A: ")
    filasA = int(respuesta)
    respuesta = input("Columnas matriz A: ")
    columnasA = int(respuesta)
    respuesta = input("\nFilas matriz B: ")
    filasB = int(respuesta)
    respuesta = input("Columnas matriz B: ")
    columnasB = int(respuesta)
